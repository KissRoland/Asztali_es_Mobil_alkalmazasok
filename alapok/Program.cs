    ...
    internal class Program
    {
        ...
        **/
        ...
        static void feladat34()
        {
            ...
            Console.WriteLine($"'{input}' {Convert.ToInt32(input)}");
        }
        ...
        static void task41()
        {
            ...
            for (char i = 'A'; i <= 'Z'; i++)
            {
                Enumerable.Range(i, number).Select(a => new { A = (char)(a) }).ToList().ForEach(c => Console.Write(c.A));
                Console.WriteLine();
                number--;
            }
        }
